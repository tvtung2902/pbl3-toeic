...
@MultipartConfig
@WebServlet (urlPatterns = {"/teacher/setting/set-account","/teacher/setting/set-password"})
public class MyAccountController extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	     ...
	     switch (actionString) {
         case "/teacher/setting/set-account": {
             set_account(req, resp);
             break;
         }
         case "/teacher/setting/set-password": {
             set_pass(req, resp);
             break;
         }
         }
	 ...
	 public void set_account(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
			...
			resp.sendRedirect("/MVC/teacher/course");
	    }
