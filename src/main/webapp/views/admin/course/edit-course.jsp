...
.menu .item li:nth-child(2) i{
    ...
    <div class="section-one" style=" margin-bottom: 10px;">       
      ...
      <div class="main-create"> 
        <div class="wrap"> 
          <form action="/MVC/admin/course/edit" method="post" enctype="multipart/form-data" onsubmit="return validateFormEditCourse();">    
            <div class="form-group" >
              <label for="nameCourse" name="courseName">Tên khóa học*:</label>
              <input name="courseName" type="text" class="form-control" id="nameCourse" onblur="checkNameCourse();"value="<%=courseModel.getCourseName()%>">
            ...
            <div class="row">
              ...
              <div class="col-6">
                <div class="form-group">
                  ...
                  <br>
                  <input name="teacherID" list="teachers" class="col-sm-6 custom-select custom-select-sm" id="teacher" onblur="checkTeacher();" value="<%=courseModel.getTeacherID() %>">
            ...
            <div class="row">
              ...
              <div class="col-6">
                <div class="form-group">
                  ...
                  <input name="duration" type="number" class="form-control" id="duration"onblur="checkDuration();"value="<%=courseModel.getDuration()%>">
              ...
              <div class="col-6">
                <div class="form-group">
                  ...
                  <input name="price" type="number" class="form-control" id="price" step="price" onblur="checkPrice();"value="<%=Math.round(courseModel.getPrice())%>">
...
<div class="col-6">
                <div class="form-group">
                  ...
                  <input name="input" type="number" class="form-control" id="input"onblur="checkInput();"value="<%=courseModel.getInput()%>">
              ...
              <div class="col-6">
                <div class="form-group">
                  ...
                  <input name="target" type="number" class="form-control" id="output"onblur="checkOutput();"value="<%=courseModel.getTarget()%>">
            ...
            <div class="row">
              ...
              <div class="col-6">
                <div class="form-group">
                  ...
                  <input name="percentSalary" type="number" class="form-control" id="percentSalary" onblur="checkPercentSalary();"value="<%=courseModel.getPercentSalary()%>">
              ...
              <div class="col-6">
                <div class="form-group">
                  ...
                  <input name="percentDiscount" type="number" class="form-control" id="percentDiscount" onblur="checkPercentDiscount();"value="<%=courseModel.getPercentSalary()%>">
...
isValid=true;
    ...
    function validateFormEditCourse() {
