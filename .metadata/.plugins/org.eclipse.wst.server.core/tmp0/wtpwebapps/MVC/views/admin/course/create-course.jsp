...
<body>
    ...
    <div class="section-one" style="margin-top: 95px; margin-bottom: 10px;">       
      ...
      <div class="main-create"> 
        <div class="wrap"> 
          <form action="/MVC/admin/course/create" method="post" enctype="multipart/form-data">    
            ...
            <div class="row">
              ...
              <div class="col-6">
                <div class="form-group">
                  ...
                  <input name="percentSalary" type="number" class="form-control" id="percentSalary">
                </div> 
              </div>
              ...
              <div class="col-6">
                <div class="form-group">
                  ...
                  <input name="percentDiscount" type="number" class="form-control" id="percentDiscount">
                </div>
              </div>
            </div>
