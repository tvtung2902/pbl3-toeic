...
<div class="menu" id="menu">
	<div class="menu-btn" id="close-btn" onclick="closefunc()">
		<i class="fa-solid fa-chevron-left" style="padding: 10px;"></i>
	</div>
	<div class="menu-btn hidden" id="open-btn" onclick="openfunc()">
		<i class="fa-solid fa-chevron-right" style="padding: 10px;"></i>
	</div>
	...
	<div class="item">
		...
		<li><i class="fa-solid fa-house"></i> <a href="/MVC/admin">Tổng
				Quan</a></li>
		<li><i class="fa-solid fa-book-open-reader"></i> <a  
			href="/MVC/admin/course">Quản Lí Khoá Học</a></li>
		<li><i class="fa-solid fa-ticket"></i> <a
			href="/MVC/admin/coupon">Quản Lí Coupon</a></li>
		<li><i class="fa-solid fa-money-check-dollar"></i> <a
			href="/MVC/admin/register-course">Xác Nhận Đăng Kí</a></li>
		<li><i class="fa-solid fa-file-lines"></i> <a href="/MVC/admin/tests">Quản
				Lí Đề Thi</a></li>
		<li><i class="fa-solid fa-users"></i> <a href="/MVC/admin/users">Quản
				Lí Người Dùng</a></li>
		<li><i class="fa-solid fa-money-check-dollar"></i> <a
			href="/MVC/admin/statistics">Thống Kê</a></li>
		<li class="logout"><i
			class="fa-solid fa-arrow-right-from-bracket"></i> <a
			href="/MVC/logout">Đăng xuất</a></li>
		</ul>
	</div>
</div>
      ...
      <div class="modal-body">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="profile" role="tabpanel"
                            ...
                            <form action="/MVC/admin/set-account" method="post" enctype="multipart/form-data" onsubmit="return validateFormAccount();">
                                <div class="row">
                                    <div class="col-12">
                        ...
                        <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="password">
                            <form onsubmit="return validateForm()" action="/MVC/admin/set-password" method="post">
                                <div class="row">
                                    <div class="col-12">
