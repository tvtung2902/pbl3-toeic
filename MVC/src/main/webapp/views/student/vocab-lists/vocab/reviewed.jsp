     ...
     <div class="section-one">
        <div class="container">
            <div class="inner-title">
                <h2>Ôn tập: <%=vocabListsModel.getNameList() %></h2>
            </div>
           <%
            String path=(String)request.getAttribute("path");
            String learnpath = path.replace("learned", "learn");
            String tmp=path.replace("/review", "");
            String stopPath =tmp.replace("action=learned&", "");
            %>
            <div class="inner-controlpage">
                <a class="back-list"href="<%=learnpath %>"> <i class="fa-brands fa-leanpub"></i>  Học từ mới</a>
