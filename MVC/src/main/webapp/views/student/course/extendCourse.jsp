...
<body>
    ...
    System.out.println(courseModel.getPercentDiscount());
    %>
    <div class="main">
        <div class="container">
            <div class="row">
                <div class="col-xl-8">
                    <div class="inner-wrap">
                        <h3 class="inner-title">Gia hạn</h3>
                        <div class="pay-content">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-8">
                                                    ...
                                                    <div class="box">
                                                        ...
                                                        <p id="new-price-1" class="price"><%=CourseModel.getPriceCH(courseModel.getPrice()-courseModel.getPercentDiscount()*courseModel.getPrice()/100) %></p>
                                                    </div> 
                                                </div>
                                            </div>
                                            <div class="text-center" style="color: red;font-size: 14px;font-weight: 400;"> Gia hạn khóa học sẽ được giảm học phí lên đến <%=courseModel.getPercentDiscount()%>% </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="inner-info">
                                            <div class="row">
                                                ...
                                                <div class="col-xl-8">
                                                    ...
                                                    <div class="box">
                                                        <p class="title">Số tiền cần chuyển</p>
                                                        <p id="new-price-2" class="price"><%=CourseModel.getPriceCH(courseModel.getPrice()-courseModel.getPercentDiscount()*courseModel.getPrice()/100) %></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="text-center" style="color: red;font-size: 14px;font-weight: 400;"> Gia hạn khóa học sẽ được giảm học phí lên đến <%=courseModel.getPercentDiscount()%>% </div>
                            ...
                            <div class="inner-button">
                                <form action="/MVC/course/course-detail/pay" method="post">
                                    ...
                                    <input type="hidden" id="input-price" name="price" value="<%=courseModel.getPrice()*(100-courseModel.getPercentDiscount())/100 %>">
                ...
                <div class="col-xl-4">
                    <div class="inner-wrap">
                        ...
                        <p class="course-price">Giá tiền: <%=CourseModel.getPriceCH(courseModel.getPrice()-courseModel.getPercentDiscount()*courseModel.getPrice()/100) %></p>
    ...
    <script>
        ...
        function applyDiscount() {
            ...
            var price = parseFloat(<%=courseModel.getPrice()*(100-courseModel.getPercentDiscount())/100 %>);
