...
display: flex;
      ...
      <div class="main-create"> 
        <div class="wrap">    
			...
			<div class="wrap-button">
				<%if(isFull) {%><button type="submit" class="add-btn" data-toggle="modal" data-target="#add-data">Thêm</button> <%} %>
				<a href="/MVC/teacher/tests/part/format?testsID=<%=request.getParameter("testsID")%>" type="button" class="btn add-btn">Sắp sếp</a>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-Fy6S3B9q64WdZWQUiU+q4/2Lc9npb8tCaSX9FK7E8HnRr0Jz8D6OP9dO5Vg3Q9ct" crossorigin="anonymous"></script>
			...
			function validateFormAdd3(form) {
				var begin= 0;
				var end= <%= (int)request.getAttribute("questionCount")/2 %>
			    let isValid = true;
	...
	function validateFormAddData1(form) {
	    ...
	    if (isNaN(orderNumber) || orderNumber === null) {
	        ...
	        if (orderNumbers.includes(orderNumber)) {
	            isValid = false;
	            alert("Số thứ tự đã tồn tại");
	        }else if(orderNumber<147 || orderNumber>200){
	            isValid = false;
	            alert("Số thứ tự nằm ngoài giá trị cho phép.");
	        }
	        else
